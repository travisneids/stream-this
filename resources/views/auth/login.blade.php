...
<head>
    <meta charset="utf-8" />
    <title>Stream This | Login Page</title>
    ...
    <div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                    Stream This
                    <small>manage rentals and customers</small>
                </div>
                <div class="icon">
            ...
            <div class="login-content">
                <form action="/auth/login" method="POST" class="margin-bottom-0">
                    <div class="form-group m-b-20">
                        <input type="text" class="form-control input-lg" placeholder="Email Address" value="{{ old('email') }}" required>
                    </div>
                    <div class="form-group m-b-20">
